...
#define NUM_LEDS    72
#define FASTLED_USE_GLOBAL_BRIGHTNESS
CRGB leds[NUM_LEDS];
...
int main(int argc, char *argv[]) {
  try {
    // Correction is in BGR order even though LEDs are RGB order
    FastLED.addLeds<LED_TYPE, SPI_BUS, SPI_CS, COLOR_ORDER, DATA_RATE_MHZ(12)>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip);
...
SimplePatternList gPatterns = { fire, pride, pacifica, cylon, white, rainbow, rainbowWithGlitter, confetti, sinelon, juggle, bpm };
